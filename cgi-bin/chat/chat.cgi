...
#if ($DATA{'n'} =~ /[^\w|Á|È|Ê|Ë|Ì|Í|Î|Ï|ä|Ñ|Ó|Ô|Õ|Ö|Ø|Ù|Ú|Û|Ý|Þ|ß|á|ã|ä|æ|í|À|Â|Ã|Ä|Å|Æ|Ç|É|Ð|Ö|Ò|à|å|æ|ç|è|é|ê|ë|ì|í|î|ï]/i) {
...
@arab = ("Á","È","Ê","Ë","Ì","Í","Î","Ï","ä","Ñ","Ó","Ô","Õ","Ö","Ø","Ù","Ú","Û","Ü","Ý","Þ","ß","á","ã","ä","æ","í","À","Â","Ã","Ä","Å","Æ","Ç","É","Ð","Ö","Ò","à","å","æ","ç","è","é","ê","ë","ì","í","î","ï");

#Ç È Ê Ë Ì Í Î Ï Ð Ñ Ò Ó Ô Õ Ö Ø Ù Ú Û Ý Þ ß á ã ä åÜ æ í
...
if (!$DATA{'n'} or length($DATA{'n'}) > 15 or !-e "$root/online/users/$DATA{'n'}"){
